      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            15년 경험의 전문가가 고객의 모든 요구사항을 원스톱으로 해결합니다
          </p>

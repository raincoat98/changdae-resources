    ...
    ferrous: [
      {
        ...
        change: "+5",
        trend: "up",
        description: "두꺼운 철판, 형강 등",
      },
      {
        name: "경량철 (Light Steel)",
        price: "380",
        unit: "원/kg",
        change: "+3",
        trend: "up",
        description: "얇은 철판, 캔류 등",
      },
      {
        name: "주철 (Cast Iron)",
        price: "420",
        ...
        change: "+8",
        trend: "up",
        description: "맨홀뚜껑, 주물 등",
      },
      {
        name: "가전철 (Appliance Steel)",
        price: "400",
        unit: "원/kg",
        change: "±0",
        trend: "stable",
        description: "냉장고, 세탁기 등",
      },
      {
        name: "자동차철 (Auto Steel)",
        price: "480",
        unit: "원/kg",
        change: "+12",
        trend: "up",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 text-center">
            <p className="text-green-100">
              💰 첫 방문 고객{" "}
              <span className="text-yellow-300 font-bold">시세 우대</span> +
              <span className="text-yellow-300 font-bold"> 운반비 할인</span>{" "}
              혜택!
            </p>
          </div>
        </div>
